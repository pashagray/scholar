module TableHandler
  class AdminUsersStudents < BaseClass
    ...
    def available_columns
      [
        ...
        { name: :student_profile_created_at, type: :datetime, align: :center },
        { name: :student_profile_date_of_admission, type: :date, align: :center }
      ]
    end
